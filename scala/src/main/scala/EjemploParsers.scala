...
import parser.{DrawParsers, char, integer, parserRectangulo, sepByCombinator, string}
import scalafx.scene.paint.Color
import tadp.{Punto, contador}
import tadp.internal.TADPDrawingAdapter
import tadp.utilities.aplanandoAndo
import tree._
...
//  println(aplanandoAndo((List(1,2,None,3),1)))
//  println(aplanandoAndo((List(1,2,None,3),List(1,2,None,3))))
//  println((sepByCombinator(integer(),char('-'))<>(sepByCombinator(string("sabale"),char(',')))).parse("123-12-123-4-2-432-1234-321-23-421-1234-32123-4321sabale,sabale"))
...
//  DrawParsers.parse(Source.fromFile("C:\\Users\\Martin\\Documents\\TADP\\grupo12-2020-2c\\scala\\src\\main\\scala\\parser\\carpin.txt").mkString)
