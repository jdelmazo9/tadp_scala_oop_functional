...
//    (parserRectangulo <|> parserTriangulo <|> parserCirculo <|> parserColor <|> parserEscala <|> parserGrupo).parse(text)
    (parserTriangulo <|> parserRectangulo <|> parserCirculo <|> parserColor <|> parserEscala <|> parserGrupo).parse(text)
...
//  println(contador.get_id("prueba"))
//  println(contador.get_id("prueba1"))
//  println(contador.get_id("prueba1"))
//  contador.inc_id("prueba")
//  contador.inc_id("prueba")
//  contador.inc_id("prueba")
//  contador.inc_id("prueba1")
//  contador.inc_id("prueba1")
//  contador.inc_id("prueba1")
//  contador.inc_id("prueba1")
//  contador.inc_id("prueba")
